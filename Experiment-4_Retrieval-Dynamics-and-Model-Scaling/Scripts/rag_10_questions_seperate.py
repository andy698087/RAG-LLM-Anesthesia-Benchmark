...
log_name = str(max_new_tokens) + '_' + str(int8_threshold) + '_k' + '.txt'
...
llm_model = AutoModelForCausalLM.from_pretrained(model_name,
                                                 cache_dir='/home/phuongnq5/RAG_ASA_DATA/model/',
...
Choose only one answer (A), (B), (C), (D) or (E) and give explaination in step by step.\n\n"""
    ...
    answer = generate(prompt, rag_generate_chain, retrieved_docs[i])
