...
# ============================================================================================================================
# Test on all 3 sets
for ques_num in range(1,4,1): # ques_num represent the index in the three 100-question
    # Setup paths for read & write
    log_name = f"{test_type}_{max_new_tokens}_{int8_threshold}_log_ques{ques_num}"
    result_log = f'<PROJECT_ROOT>/data_result_formal_1/{test_type}/{log_name}.txt'
...
Choose only one answer (A), (B), (C), (D) or (E) and give explaination in step by step.\n"""
        ...
        iter_answer = generate(prompt, rag_generate_chain, asa_data.iloc[i,8])
