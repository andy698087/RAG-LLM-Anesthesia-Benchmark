...
asa_data_path = '<PATH_TO_THE_46_QUESTIONS_CSV_DATASET>'
...
The JSON answer should contain 2 keys, key 'answer' correspond to answer choice (A, B or C) while key 'Explain' contain the short step-by-step explaination. \n
...
for i in range (0,asa_data.shape[0],1):    
    ...
    Choose only one answer (A), (B) or (C) and give explaination in step by step.\n\n"""        
    # Get answer
